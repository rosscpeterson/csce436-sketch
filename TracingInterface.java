...
public class TracingInterface
{
	...
	public class MouseUpListener implements MouseListener
	{
		...
		public void mouseReleased(MouseEvent e)
		{
			...
			for (int i = 0; i < strokes.get(current_stroke).getSize(); i++)
			{
				System.out.println(strokes.get(current_stroke).getTimestamp(i));
			}
			System.out.println();
		}
	}
	...
	public class PaintListener implements MouseMotionListener
	{
		public void mouseDragged(MouseEvent e)
		{
			...
			// WILL CHANGE TO BE MILLISECONDS
			// ALSO ADD CODE TO MEASURE BEGIN AND END DATE
			// Timestamp
			Calendar calendar = Calendar.getInstance();
			strokes.get(current_stroke).addTimestamp(new Date(calendar.getTime().getTime()));
